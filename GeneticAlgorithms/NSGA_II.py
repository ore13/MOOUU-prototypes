...
class NSGA_II(AbstractMOEA):
    ...
    # ------------------------External methods--------------------------------
    def __init__(self, objectives, bounds, number_objectives, model=None, pst=None,
        ...
        """
        super().__init__(objectives=objectives, bounds=bounds, number_objectives=number_objectives,
                         constraints=constraints, cross_prob=cross_prob, cross_dist=cross_dist, mut_prob=mut_prob,
                         mut_dist=mut_dist, iterations=iterations, model=model, pst=pst)
