...
class AbstractMOEA:
    ...
    # ------------------------External methods--------------------------------
    def __init__(self, objectives, bounds, number_objectives, pst=['python', 'TestProblems\\StochasticProblemSuite.py'],
                 model=None, constraints=None, cross_prob=0.8, cross_dist=20, mut_prob=0.01, mut_dist=20,
                 iterations=20):
